package ma.soundwave.catalogcontext.application;

import ma.soundwave.catalogcontext.application.dto.FavoriteSongDTO;
...
import ma.soundwave.catalogcontext.application.mapper.SongContentMapper;
import ma.soundwave.catalogcontext.application.mapper.SongMapper;
...
import ma.soundwave.catalogcontext.repository.FavoriteRepository;
import ma.soundwave.catalogcontext.repository.SongContentRepository;
import ma.soundwave.catalogcontext.repository.SongRepository;
import ma.soundwave.infrastructure.service.dto.State;
import ma.soundwave.infrastructure.service.dto.StateBuilder;
import ma.soundwave.usercontext.ReadUserDTO;
import ma.soundwave.usercontext.application.UserService;
...
public class SongService {
    ...
    public boolean deleteByPublicId(UUID publicId) {
        Optional<Song> songOpt = songRepository.findOneByPublicId(publicId);
        if (songOpt.isPresent()) {
            Song song = songOpt.get();
            songContentRepository.deleteBySongId(song.getId());
            favoriteRepository.deleteBySongPublicId(publicId);
