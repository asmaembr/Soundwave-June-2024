package ma.soundwave.catalogcontext.presentation;

import com.fasterxml.jackson.databind.ObjectMapper;
import ma.soundwave.catalogcontext.application.SongService;
...
import ma.soundwave.infrastructure.service.dto.StatusNotification;
...
public class SongResource {
    ...
    @DeleteMapping("/songs/{publicId}")
    public ResponseEntity<Object> deleteSong(@PathVariable UUID publicId) {
        boolean isDeleted = songService.deleteByPublicId(publicId);
        if (isDeleted) {
            return ResponseEntity.noContent().build();
        } else {
            ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.NOT_FOUND, "Song not found");
